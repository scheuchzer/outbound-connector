...
/**
 * Implementation for the {@link ExtendedEchoConnectionFactory}. As you can see no
 * additional code is needed.
 * 
 * @author Thomas Scheuchzer, java-adventures.com
 * 
 */
public class InMemoryExtendedEchoConnectionFactory extends
		AbstractConnectionFactory<ExtendedEchoConnection> implements
		ExtendedEchoConnectionFactory {

	private static final long serialVersionUID = 1L;

	public InMemoryExtendedEchoConnectionFactory(ManagedConnectionFactory mcf,
